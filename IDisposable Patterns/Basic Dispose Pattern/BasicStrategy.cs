...
///     has determined it needs to free additional memory.</para>
/// <para>
...
///     unmanaged memory will be freed at that time.</para>
/// <para>
...
///     call Dispose explicitly to ensure unmanaged memory is dealt with in a known, and guaranteed way.</para>
/// <para>
